...
import com.ravinada.cryptocompare.databinding.FirstPortfolioBindingImpl;
...
import com.ravinada.cryptocompare.databinding.ItemRoomsListBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_FIRSTPORTFOLIO = 7;
  ...
  private static final int LAYOUT_ITEMROOMSLIST = 12;

  private static final int LAYOUT_MAINLISTFRAGMENT = 13;

  private static final int LAYOUT_PORTFOLIODIALOG = 14;
  ...
  static {
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.ravinada.cryptocompare.R.layout.first_portfolio, LAYOUT_FIRSTPORTFOLIO);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.ravinada.cryptocompare.R.layout.item_rooms_list, LAYOUT_ITEMROOMSLIST);
  ...
  public ViewDataBinding getDataBinder(DataBindingComponent component, View view, int layoutId) {
    ...
    if(localizedLayoutId > 0) {
      ...
      switch(localizedLayoutId) {
        ...
        case  LAYOUT_FIRSTPORTFOLIO: {
          if ("layout/first_portfolio_0".equals(tag)) {
            return new FirstPortfolioBindingImpl(component, view);
          }
          throw new IllegalArgumentException("The tag for first_portfolio is invalid. Received: " + tag);
        }
        ...
        case  LAYOUT_ITEMROOMSLIST: {
          if ("layout/item_rooms_list_0".equals(tag)) {
            return new ItemRoomsListBindingImpl(component, view);
          }
          throw new IllegalArgumentException("The tag for item_rooms_list is invalid. Received: " + tag);
        }
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      ...
      sKeys.put("layout/first_portfolio_0", com.ravinada.cryptocompare.R.layout.first_portfolio);
      ...
      sKeys.put("layout/item_rooms_list_0", com.ravinada.cryptocompare.R.layout.item_rooms_list);
